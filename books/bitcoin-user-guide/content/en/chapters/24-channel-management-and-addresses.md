...
It makes public identity and channel health feel like the same problem from different angles. A well-run Lightning node is one that can be found, trusted, and repaired when necessary.
